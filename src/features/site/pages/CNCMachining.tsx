...
const CNCMachining = () => {
  ...
  const images = [
    { 
      src: "/optimized/site/capabilities/Contract manufacturing/33-1080.webp", 
      alt: "Contract manufacturing", 
      title: "Latest CNC Technology" 
    },
    { 
      src: "/optimized/site/capabilities/Contract manufacturing/34-1080.webp", 
      alt: "Machine controls", 
      title: "Reduced Setup Times" 
    },
    { 
      src: "/optimized/site/capabilities/Contract manufacturing/35-1080.webp", 
      alt: "High-quality machined parts", 
      title: "Fastest Turnaround" 
    },
    { 
      src: "/optimized/site/capabilities/Contract manufacturing/36-1080.webp", 
      alt: "Advanced tooling", 
    ...
    <div className="bg-white text-gray-900">
        ...
        >
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            <p className="text-xl leading-relaxed mb-6">
              Flexible machining solutions designed for speed, precision, and cost-efficiency.
            </p>
            
            <p className="text-lg leading-relaxed mb-6">
              Latest CNC milling and turning technology with reduced setup and cycle times. Fastest turnaround in the industry while maintaining competitive global pricing.
            </p>
            
            <p className="text-lg leading-relaxed">
              Our advanced CNC capabilities ensure precision manufacturing with optimized processes that deliver exceptional quality and reliability for all your machining needs.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Contract Manufacturing Excellence</h2>
