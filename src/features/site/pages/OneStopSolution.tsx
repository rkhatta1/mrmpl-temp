...
const OneStopSolution = () => {
  ...
  const images = [
    { 
      src: "/optimized/site/capabilities/One stop solution/5-1080.webp", 
      alt: "Modern manufacturing facility", 
      title: "Advanced Facility" 
    },
    { 
      src: "/optimized/site/capabilities/One stop solution/6-1080.webp", 
      alt: "Assembly line operations", 
      title: "Assembly Operations" 
    },
    { 
      src: "/optimized/site/capabilities/One stop solution/7-1080.webp", 
      alt: "Quality control process", 
      title: "Quality Control" 
    },
    { 
      src: "/optimized/site/capabilities/One stop solution/8-1080.webp", 
    ...
    <div className="bg-white text-gray-900">
        ...
        >
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            <p className="text-xl leading-relaxed mb-6">
              End-to-end manufacturing of brass products, from design to delivery, built on internationally approved materials and processes.
            </p>
            
            <p className="text-lg leading-relaxed mb-6">
              Single source for all your brass component needs with access to the latest global technologies. Competitive pricing without compromising quality and reliable, on-time supply chain management.
            </p>
            
            <p className="text-lg leading-relaxed">
              This comprehensive approach reduces vendor management complexity, ensures faster project completion times, and provides you with a single point of contact for all your manufacturing requirements.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Our Comprehensive Capabilities</h2>
