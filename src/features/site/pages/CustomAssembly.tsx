...
const CustomAssembly = () => {
  ...
  const images = [
    { 
      src: "/optimized/site/capabilities/Custom components/21-1080.webp", 
      alt: "Custom assembly operations", 
      title: "Complex Machining" 
    },
    { 
      src: "/optimized/site/capabilities/Custom components/22-1080.webp", 
      alt: "Manufacturing facility", 
      title: "Multiple Materials" 
    },
    { 
      src: "/optimized/site/capabilities/Custom components/23-1080.webp", 
      alt: "Quality control", 
      title: "Vibraseal & Loctite" 
    },
    { 
      src: "/optimized/site/capabilities/Custom components/24-1080.webp", 
      alt: "Material management", 
      title: "Flexible Design-to-Delivery" 
    }
  ];
    ...
    <div className="bg-white text-gray-900">
      ...
      <section className="relative py-24 px-4 pt-32">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800 leading-tight">
            Custom Components & Assembly
          </h1>
          
          <div className="prose prose-lg max-w-none text-gray-600">
            <p className="text-xl leading-relaxed mb-6">
              Tailored solutions to match your unique requirements, designed, machined, and assembled in-house.
            </p>
            
            <p className="text-lg leading-relaxed mb-6">
              Complex machining for parts from 5mm to 135mm with brass, bronze, aluminum, and stainless steel options. Vibraseal and Loctite applications available.
            </p>
            
            <p className="text-lg leading-relaxed">
              Our flexible design-to-delivery process ensures custom solutions that meet your exact specifications with precision manufacturing and quality assurance.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Custom Assembly Capabilities</h2>
