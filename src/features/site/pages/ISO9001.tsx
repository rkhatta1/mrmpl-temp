...
const ISO9001 = () => {
  ...
  const images = [
    { 
      src: "/optimized/site/capabilities/ISO/9-1080.webp", 
      alt: "ISO 9001 certification document", 
      title: "ISO 9001:2015 Certified" 
    },
    { 
      src: "/optimized/site/capabilities/ISO/10-1080.webp", 
      alt: "Quality control inspection", 
      title: "Quality Management" 
    },
    { 
      src: "/optimized/site/capabilities/ISO/11-1080.webp", 
      alt: "Modern manufacturing facility", 
      title: "Controlled Environment" 
    },
    { 
      src: "/optimized/site/capabilities/ISO/12-1080.webp", 
    ...
    <div className="bg-white text-gray-900">
        ...
        >
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            <p className="text-xl leading-relaxed mb-6">
              Our ISO-certified quality system ensures every product meets the highest global standards.
            </p>
            
            <p className="text-lg leading-relaxed mb-6">
              Rigorous quality checks at every stage with ongoing employee training and education. Continuous improvement culture supported by state-of-the-art testing and measurement capabilities.
            </p>
            
            <p className="text-lg leading-relaxed">
              With a 99.8% quality pass rate and over 15 years of certification, we have proven our ability to maintain the highest standards of quality management and customer satisfaction.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Quality Management Excellence</h2>
